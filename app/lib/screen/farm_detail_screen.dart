...
class _FarmDetailScreenState extends State<FarmDetailScreen> {
  ...
  Future<void> _fetchFarmProducts() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('${Constants.baseUrl}/products/by-farmer/$phone'),
      );
  ...
  Widget build(BuildContext context) {
    ...
    String name =
        (widget.farmData['companyName'] != null &&
            widget.farmData['companyName'].toString().isNotEmpty)
        ? widget.farmData['companyName']
        : (widget.farmData['fullName'] ?? "Nông trại");
